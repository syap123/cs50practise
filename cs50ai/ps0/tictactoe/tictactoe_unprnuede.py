...
def max_value(board):
    ...
    for action in actions(board):
        best_utility_score_now = max(best_utility_score_now, min_value(result(board,action)))
...
def min_value(board):
    ...
    best_utility_score_now = 999
    for action in actions(board):
        best_utility_score_now = min(best_utility_score_now, max_value(result(board,action)))
    return best_utility_score_now    
